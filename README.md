...
``` r
devtools::install_github("madsenmat/foofactors")
```
...
The `mean_dif()` function returns a value that is the difference between the mean of two numeric levels supplied. Saving the time of two operations into 1.
